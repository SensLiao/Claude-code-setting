...
function run(rawInput) {
  // v4.0.3 fix: return whole {output, exitCode} object so blocking exit codes
  // propagate through run-with-flags.js emitHookResult(). Previously returned
  // only .output (string), which run-with-flags treated as pass-through exit 0,
  // silently dropping exit code 2 from violations. See H2-B HIGH-3.
