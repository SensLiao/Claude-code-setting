...
- **Context-rich prompts from them**: they give you specific paths (`/Users/you/Downloads/output.mp4`), not "the video I sent". Don't ask "which file" if they've already told you.
...
- **GSD-aligned**: the user has a GSD (Get Shit Done) workflow in their global CLAUDE.md (`/Users/you/.claude/CLAUDE.md`). The U2 project didn't use full GSD discuss → plan → execute, but in their other projects they do. If a session feels heavy / multi-week, suggest GSD framework rather than ad-hoc.
