...
description: >-
  Analyzes meeting transcripts and recordings to surface behavioral patterns, communication anti-patterns and actionable coaching feedback. Use whenever the user points to transcripts (.txt, .md, .vtt, .srt, .docx), asks about their communication habits or how they run meetings, wants speaking-ratio analysis, mentions filler words or conflict avoidance, or wants to compare communication across time periods. Also triggers on Granola, Otter, Fireflies or Zoom transcripts, and on casual asks like "look at my meetings" or "how do I come across in meetings".
---
