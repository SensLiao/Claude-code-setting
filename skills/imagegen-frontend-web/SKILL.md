...
description: >-
  Frontend image-direction skill for generating premium, conversion-aware website design references. CRITICAL OUTPUT RULE — one separate horizontal image PER SECTION; an 8-section landing page produces 8 images, never a compressed board. Enforces composition variety, background-image freedom, varied CTAs, varied hero scales, a narrative concept spine, second-read moments and one consistent palette across all images. For landing pages, marketing sites and product comps that developers or coding models must recreate accurately.
---
