...
description: >-
  Retroactive audit of an implemented AI phase evaluation coverage — checks the implementation against the AI-SPEC.md evaluation plan, scores each eval dimension COVERED / PARTIAL / MISSING, and produces a scored EVAL-REVIEW.md with findings, gaps and remediation guidance. Spawned by the eval-review orchestrator.
