...
description: >-
  Researches the business domain and real-world context of the AI system being built — domain-expert evaluation criteria, industry-specific failure modes, regulatory context, and what practitioners call good — before the eval-planner turns it into measurable rubrics. Spawned by the ai-integration-phase orchestrator.
