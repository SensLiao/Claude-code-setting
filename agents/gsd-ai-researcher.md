...
description: >-
  Researches a chosen AI framework official docs into implementation-ready guidance — best practices, syntax, core patterns and pitfalls for the specific use case. Writes the Framework Quick Reference and Implementation Guidance sections of AI-SPEC.md. Spawned by the ai-integration-phase orchestrator.
